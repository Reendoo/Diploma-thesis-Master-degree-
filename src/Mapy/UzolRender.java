 ...
 * @author rendo
 */
public class UzolRender implements WaypointRenderer<UzolWaypoint>
{
    private static final Log log = LogFactory.getLog(WaypointRenderer.class);
...
//    private final Font font = new Font("Lucida Sans", Font.BOLD, 10);
    ...
    @Override
    public void paintWaypoint(Graphics2D g, JXMapViewer viewer, UzolWaypoint w)
    {
