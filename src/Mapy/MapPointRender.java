 ...
 * @author rendo
 */
public class MapPointRender implements WaypointRenderer<MapPoint> {
    ...
    */
    ...
    @Override
    public void paintWaypoint(Graphics2D g, JXMapViewer viewer, MapPoint w) {
